...
import static org.openhab.binding.webbrick.WebBrickBindingConstants.CHANNEL_LIGHTLEVEL;
...
import org.openhab.binding.webbrick.config.DimmerConfig;
 ...
 */
public class DimmerHandler extends WebBrickHandler {
    ...
    public int getIntegrationId() {
        this.logger.info("...in getIntegrationId..Dimmer Thing Handler");
    ...
    public void initialize() {
        this.logger.info("...in initialise..Dimmer Thing Handler");
    ...
    public void handleUpdate(WebBrickCommandType type, String... parameters) {
        if (type == WebBrickCommandType.OUTPUT && parameters.length > 1
